...
def add_glow_line(ax, x, y, color="#00d4ff", linewidth=2.5, label=None):
    ...
    ax.plot(x, y, color=color, linewidth=linewidth, alpha=1.0, solid_capstyle="round", label=label)


def add_gradient_fill(ax, x, y, color_bottom="#00d4ff", color_top="#7c4dff", alpha=0.3, y_min=None):
