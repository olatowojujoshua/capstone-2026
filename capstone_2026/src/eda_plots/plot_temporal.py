...
def run():
    ...
    # Set axis limits FIRST so gradient fill knows the bounds
    ...
    add_gradient_fill(ax, x_smooth, y_smooth, "#00d4ff", "#7c4dff",
                      alpha=0.25, y_min=y_min)

    # Glow line
    add_glow_line(ax, x_smooth, y_smooth, color="#00d4ff", linewidth=2.5)

    # Data point markers
    ax.scatter(x, y, color="#00d4ff", s=30, zorder=6,
